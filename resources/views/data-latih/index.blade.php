            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="datalatih-table" class="table table-striped table-bordered zero-configuration">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Nama Pasien</th>
...
<script>
    $(document).ready(function(){
        //define datatable
        var table = $('#datalatih-table').DataTable({
            processing: false,
            serverSide: true,

            ajax: "{{ route('data-latih.datatable') }}",
            columns: [
